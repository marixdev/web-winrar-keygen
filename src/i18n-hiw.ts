...
const en: HiwTranslation = {
  ...
  hiwS1Title: "Overview",
  hiwS1P1: "WinRAR uses an ECC (Elliptic Curve Cryptography) digital signature algorithm to generate the license file rarreg.key. Specifically, it uses a custom variant of ECDSA (Elliptic Curve Digital Signature Algorithm) over a binary Galois field.",
  ...
  hiwS10Step1: "Generate public key from Username → ECC point compression → 64 hex chars (Temp)",
  hiwS10Step2: "Create Items[3] = \"60\" + first 48 chars of Temp",
  hiwS10Step3: "Create Items[0] = ECCCompress(GeneratePublicKey(GeneratePrivateKey(Items[3])))",
  ...
  hiwS12ECDS: "ECDSA",
  hiwS12ECDSDesc: "Elliptic Curve Digital Signature Algorithm",
};
...
const vi: HiwTranslation = {
  ...
  hiwS1P1: "WinRAR sử dụng thuật toán chữ ký số dựa trên đường cong Elliptic (ECC) để tạo file license rarreg.key. Cụ thể, nó dùng một biến thể tùy chỉnh của ECDSA (Thuật toán chữ ký số đường cong Elliptic) trên trường Galois nhị phân.",
  ...
  hiwS10Step1: "Tạo Public Key từ Username → nén điểm ECC → 64 hex chars (Temp)",
  hiwS10Step2: "Tạo Items[3] = \"60\" + 48 ký tự đầu của Temp",
  hiwS10Step3: "Tạo Items[0] = ECCCompress(GeneratePublicKey(GeneratePrivateKey(Items[3])))",
  ...
  hiwS12ECDS: "ECDSA",
  hiwS12ECDSDesc: "Thuật toán chữ ký số đường cong Elliptic",
};
